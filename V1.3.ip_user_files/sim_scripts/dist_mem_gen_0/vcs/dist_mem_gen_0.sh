...
# Design libraries
design_libs=(xilinx_vip xil_defaultlib xpm dist_mem_gen_v8_0_13)
...
compile()
{
  ...
  vlogan -work dist_mem_gen_v8_0_13 $vlogan_opts +v2k +incdir+"D:/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"D:/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../V1.3.srcs/sources_1/ip/dist_mem_gen_0/sim/dist_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
