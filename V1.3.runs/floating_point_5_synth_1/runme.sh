...
HD_PWD='D:/Users/paste/V1.3.runs/floating_point_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_5.tcl
